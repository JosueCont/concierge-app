    ...
    <View style={{ flex: 1 }}>
      ...
      <ScrollView style={{ zIndex: 3, flex: 1 }}>
        <View style={{ padding: 16 }}>
          ...
          >
            <Text style={styles.navItemStyle}>Mis Notificaciones</Text>
            <View style={{ height: Dimensions.get("window").height * 0.05 }} />
          </TouchableOpacity>
          ...
          {[
            <TouchableOpacity
              ...
              onPress={navigateToScreen("Home")}
            >
              <Text style={styles.navItemStyle}>Mis Cupones</Text>
              <View
                style={{ height: Dimensions.get("window").height * 0.05 }}
              />
            </TouchableOpacity>,
            ...
            >
              <Text style={styles.navItemStyle}>Mis Favoritos</Text>
              <View
                style={{ height: Dimensions.get("window").height * 0.05 }}
              />
            </TouchableOpacity>,
            ...
            <TouchableOpacity
              ...
              onPress={navigateToScreen("Reservar")}
            >
              <Text style={styles.navItemStyle}>Sucursales</Text>
              <View
                style={{ height: Dimensions.get("window").height * 0.05 }}
              />
            </TouchableOpacity>,
        ...
        <View style={{ height: Dimensions.get("window").height * 0.05 }} />
        <Text
          style={{ fontSize: 14, color: "lightgray", paddingHorizontal: 16 }}
        >
          v1.0.7
        </Text>
        <View style={{ height: Dimensions.get("window").height * 0.05 }} />
        ...
        <View style={{ paddingHorizontal: 16 }}>
          ...
          >
            <Text style={{ fontSize: 15, color: "black", opacity: 0.7 }}>
              Acerca de
            </Text>
          </TouchableOpacity>
